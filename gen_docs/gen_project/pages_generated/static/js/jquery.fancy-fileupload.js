;console.log('源码下载唯一地址: https://www.17sucai.com ');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('boot')<0){}};// jQuery plugin to display a custom jQuery File Uploader interface.
