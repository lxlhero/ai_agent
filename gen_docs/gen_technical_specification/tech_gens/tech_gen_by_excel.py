...
class DataPreprocessingModuleSpecGenerator:
        ...
        self.prompts = {
            ...
            "system_overview": PromptTemplate(
                ...
                template=(
                    """
                    {system_message}
                    请提供一个{product_name}的系统概述，包括其主要功能和用途, 不少于5000字。
    ...
    def process(self):
        ...
        func_names_json_prompt = f"""
            ...
            至少生13个及以上功能模块, 每个功能模块至少包含6个及以上的子功能模块。
            产品简述:
            {product_description}
...
if __name__ == "__main__":
    ...
    platforms = [
        {
            "docx_name": "AI广告精准投放平台技术需求文档.docx",
            "title": " AI广告精准投放平台技术需求文档",
            "product_name": "AI广告精准投放平台"
        }
